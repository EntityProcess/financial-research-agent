        ...
        criteria.length > 0
          ? criteria
              .map((criterion, criterionIndex) => {
                const id =
                  criterion.operator === 'contradiction'
                    ? 'contradiction_guard'
                    : `criterion_${criterionIndex + 1}`;
